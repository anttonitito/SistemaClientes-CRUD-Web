               ...
               <div class="container">
                  <div class="row">
                        ...
                        <div class="full">
                           <div class="center-desk">
                              <div class="logo text-center ">
                                 <a href="index.jsp"><img style="max-width: 20% ;" src="images/logo1.png" alt="#" /></a>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <ul class="costomer">
                           <li>Clientes  <a href="#">Llamar a: 989539799</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row d_flex">
                     <div class="col-md-5 ">
                        <div class="text-bg text-center">
                           ...
                           <h1>Información</h1>
                           <p>Registro de clientes en base de datos</p>
                           <a href="${pageContext.request.contextPath}/ServletControlador">Informacion de Clientes</a>
